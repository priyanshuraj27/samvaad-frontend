...
import {
    Play, Pause, SkipForward, Info, Mic, Hand, Shield, BookOpen,
...
const WSDebateScreen = () => {
    ...
    const handleNextSpeaker = useCallback(async () => {
        ...
        const speechDuration = 8 * 60; // Should be based on format
        ...
        <div className="min-h-screen bg-gray-900 text-gray-100 flex flex-col font-sans">
            ...
            <main className="flex-grow grid grid-cols-1 lg:grid-cols-4 gap-6 p-6">
                <div className="lg:col-span-1">
                    <TeamPanel teamName="Proposition" speakers={debateSession.participants.filter(p => p.team.includes('Proposition'))} {...{ currentSpeaker, userRole: debateSession.userRole, teamColor: 'prop', speakingAi }} />
                </div>
