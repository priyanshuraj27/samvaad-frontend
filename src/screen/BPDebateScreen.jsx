...
import {
    ...
    ArrowLeft, User, X as XIcon, Speaker as SpeakerIcon, SendHorizonal, Check
} from 'lucide-react';
        ...
        <div className="min-h-screen bg-gray-900 text-gray-100 flex flex-col font-sans">
            ...
            <main className="flex-grow grid grid-cols-1 lg:grid-cols-4 gap-6 p-6">
                <div className="lg:col-span-1 flex flex-col gap-6">
                    <TeamPanel teamName="Opening Government" speakers={debateSession.participants.filter(p => p.team === 'Opening Government')} {...{ currentSpeaker, userRole: debateSession.userRole, teamColor: 'gov', speakingAi }} />
                    <TeamPanel teamName="Closing Government" speakers={debateSession.participants.filter(p => p.team === 'Closing Government')} {...{ currentSpeaker, userRole: debateSession.userRole, teamColor: 'gov', speakingAi }} />
                </div>
                ...
                <div className="lg:col-span-1 flex flex-col gap-6">
                    <TeamPanel teamName="Opening Opposition" speakers={debateSession.participants.filter(p => p.team === 'Opening Opposition')} {...{ currentSpeaker, userRole: debateSession.userRole, teamColor: 'opp', speakingAi }} />
                    <TeamPanel teamName="Closing Opposition" speakers={debateSession.participants.filter(p => p.team === 'Closing Opposition')} {...{ currentSpeaker, userRole: debateSession.userRole, teamColor: 'opp', speakingAi }} />
                </div>
            </main>
